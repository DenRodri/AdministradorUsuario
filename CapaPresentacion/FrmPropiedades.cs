...
namespace Proyecto
{
    public partial class FrmPropiedades : Form
    {
        ...
        private bool AreTextBoxesFilled(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4, TextBox textBox5, TextBox textBox6, TextBox textBox7, TextBox textBox8, TextBox textBox9, TextBox textBox10)
        {
            ...
            {
                MessageBox.Show("Porfavor entre un valor en el " + textBox7.Name + " textbox");
                return false;
            }
            if (string.IsNullOrEmpty(textBox8.Text))
            {
                MessageBox.Show("Porfavor entre un valor en el " + textBox8.Name + " textbox");
                return false;
            }
            if (string.IsNullOrEmpty(textBox9.Text))
            {
                MessageBox.Show("Porfavor entre un valor en el " + textBox9.Name + " textbox");
                return false;
            }
            if (string.IsNullOrEmpty(textBox10.Text))
            {
                MessageBox.Show("Porfavor entre un valor en el " + textBox10.Name + " textbox");
                return false;
            }
            return true;
        }
        ...
        {
            if (AreTextBoxesFilled(txtCalle, txtSector, txtMunicipio, txtProvincia, txtCantBath, txtCantRoom, txtNumParq, txtCost, txtOfert, txtCosteComp))
            {
                if (Editarse == false)
                {
                    try

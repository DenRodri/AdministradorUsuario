...
namespace Proyecto
{
    public partial class FrmClientes : Form
    {
        ...
        {
            if (AreTextBoxesFilled(txtNombre, txtApellido))
            {
                if (Editarse == false)
                {
                    try
                    {
                        ...
                        objEntidad.Fecha_Creado = DateTime.Now;
                ...
                if (Editarse == true)
                {
                    try
                    {
                        ...
                        objEntidad.Nacionalidad = CountryCB.SelectedItem.ToString();
                        objEntidad.Sexo = sexo;
                        objEntidad.Fecha_Creado = Convert.ToDateTime(tablaClientes.CurrentRow.Cells[5].Value);
                        objEntidad.Creado_Por = _usuario.IdUsuario;
